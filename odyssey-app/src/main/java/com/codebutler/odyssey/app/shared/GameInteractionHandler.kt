...
class GameInteractionHandler(private val activity: Activity, private val odysseyDb: OdysseyDatabase) :
    ...
    override fun onMenuItemClick(item: MenuItem): Boolean {
        ...
        return when (item.itemId) {
            ...
            R.id.toggle_favorite -> {
                async(UI) {
                    bg {
                        odysseyDb.gameDao().update(game.copy(isFavorite = !game.isFavorite))
                    }.await()
