...
object GameMenuHelper {
    ...
    fun setupChangeDiskOption(activity: Activity?, screen: PreferenceScreen, currentDisk: Int, numDisks: Int) {
        ...
        changeDiskPreference?.entries = (0 until numDisks)
            .map { screen.context.resources.getString(R.string.game_menu_change_disk_disk, (it + 1).toString()) }
            .toTypedArray()
